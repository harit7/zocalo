...
public class ClaimPurchase extends UserPage {
        ...
        if (row != null && ! "".equals(row) && claim != null && ! "".equals(claim)) {
			...
			*/
            ...
            if (TRADE_FIELD_LABEL.equals(request.getParameter("action"))) {
                ...
                System.out.println ("***************displayedString = " + displayedString);
                ...
                if (costLimit) {
                    ...
                    System.out.println("costString : " + costString + " priceString: " + priceString);
                    System.out.println("market.asPrice(p) : " + market.asPrice(p) + " c().times(Quantity.Q100): " + c().times(Quantity.Q100));
                    ...
                    market.buyWithCostLimit(getPosition(), market.asPrice(p), getUser().cashOnHand(), getUser(), buying);
                }
            }
        }
    }
    ...
    public void htmlForBuyingMultiClaim(StringBuffer buf, MultiMarket market) {
    	System.out.println("Config.getCostLimitBuying() = " + Config.getCostLimitBuying());
    ...
    public void htmlForMultiClaimCostBuy(StringBuffer buf, MultiMarket market) {
        ...
        SortedSet<Position> sorted = market.getClaim().sortPositions2();
        /************************************************* ADDED ROHITH ****************************/
        ...
        SortedMap<String, String> positionName_vs_teamName = new TreeMap<String, String>();
        SortedMap<String, String> teamName_vs_logoName = new TreeMap<String, String>();
        
        /************************************************* ADDED ROHITH ****************************/        
      /*
        IPL Teams

        String[] teamNames = { "Mumbai Indians", "Royal Challengers Bangalore", "Chennai Super Kings",
        					  "Pune Warriors India", "Kings XI Punjab", "Delhi Daredevils", 
        					  "Kolkata Knight Riders", "Deccan Chargers", "Rajasthan Royals"};
        
        
        
        String[][] team_logos = {
			      	 	{"Mumbai Indians",             "<img src=images/Logo/Team/mi.jpg>"},
			       		{"Royal Challengers Bangalore", "<img src=images/Logo/Team/rcb.jpg>"},
			       		{"Chennai Super Kings",         "<img src=images/Logo/Team/csk.jpg>"},
			       		{"Pune Warriors India",         "<img src=images/Logo/Team/pwi.jpg>"},
			       		{"Kings XI Punjab",             "<img src=images/Logo/Team/kxi.jpg>"},
			       		{"Delhi Daredevils",            "<img src=images/Logo/Team/dd.jpg>" },
			       		{"Kolkata Knight Riders",       "<img src=images/Logo/Team/kkr.jpg>"},
			       		{"Deccan Chargers",	       "<img src=images/Logo/Team/deccan.jpg>"},
			       		{"Rajasthan Royals",            "<img src=images/Logo/Team/rr.jpg>"}
			    };        
       */
	// world cup teams
        String[][] team_logos = {   {"Mumbai Indians",             "<img src=images/Logo/Team/mi.jpg height=\"101px\" width = \"101px\">"},
                                    {"Royal Challengers Bangalore", "<img src=images/Logo/Team/rcb.jpg height=\"101px\" width = \"101px\">"},
                                    {"Chennai Super Kings",         "<img src=images/Logo/Team/csk.jpg height=\"101px\" width = \"101px\">"},
                                    {"Pune Warriors India",         "<img src=images/Logo/Team/pwi.jpg height=\"101px\" width = \"101px\">"},
                                    {"Kings XI Punjab",             "<img src=images/Logo/Team/kxi.jpg height=\"101px\" width = \"101px\">"},
                                    {"Delhi Daredevils",            "<img src=images/Logo/Team/dd.jpg height=\"101px\" width = \"101px\">" },
                                    {"Kolkata Knight Riders",       "<img src=images/Logo/Team/kkr.jpg height=\"101px\" width = \"101px\">"},
                                    {"Deccan Chargers",            "<img src=images/Logo/Team/deccan.jpg height=\"101px\" width = \"101px\">"},
                                    {"Rajasthan Royals",            "<img src=images/Logo/Team/rr.jpg height=\"101px\" width = \"101px\">"},
                                
				                    {"India",             "<img src=images/wc_logo/boards/india.jpeg height=\"101px\" width = \"101px\">"   },
                                    {"Pakistan",	  "<img src=images/wc_logo/boards/pakistan.jpeg height=\"101px\" width = \"101px\">"},
                                    {"Sri Lanka",         "<img src=images/wc_logo/boards/srilanka.png height=\"101px\" width = \"101px\">"},
                                    {"Bangladesh",        "<img src=images/wc_logo/boards/bangladesh.png height=\"101px\" width = \"101px\">"},
                                    {"Austrailia",        "<img src=images/wc_logo/boards/austrailia.png height=\"101px\" width = \"101px\">"},
                                    {"South Africa",     "<img src=images/wc_logo/boards/southafrica.png height=\"101px\" width = \"101px\">" },
                                    {"Ireland",           "<img src=images/wc_logo/boards/ireland.png height=\"101px\" width = \"101px\">"},
                                    {"New Zealand",       "<img src=images/wc_logo/boards/newzealand.jpg height=\"101px\" width = \"101px\">"},
                                    {"England",           "<img src=images/wc_logo/boards/england.svg height=\"101px\" width = \"101px\">"},
									{"West Indies",       "<img src=images/wc_logo/boards/westindies.png height=\"101px\" width = \"101px\">"},

				    				{"Zimbabwe",         "<img src=images/wc_logo/boards/zimbabwe.gif height=\"101px\" width = \"101px\">"}

                            }; 
		/* India, Pakistan, Sri Lanka, Bangladesh, Austrailia, South Africa, Ireland, New Zealand, West Indies*/
        /************************************************* ADDED ROHITH ****************************/

	
        String default_logo = "<img src = images/Logo/Team/mi.jpg>";

        int i, j;        
        for (i=0; i < positions.length; i++) {
        	//System.out.println("positions[i].getName().trim() = " + positions[i].getName().trim());
        	for (j=0; j< team_logos.length; j++)
        	{        		
        		if (positions[i].getName().trim().equals(team_logos[j][0]))
        			break;
        	}
		if(j < team_logos.length)
		{
        		positionName_vs_teamName.put(positions[i].getName().trim(), team_logos[j][0]);
        		teamName_vs_logoName.put(team_logos[j][0], team_logos[j][1]);
		}
		else
		{
			// team not found.
	                positionName_vs_teamName.put(positions[i].getName().trim(), positions[i].getName().trim());
                        teamName_vs_logoName.put(positions[i].getName().trim(), default_logo);
		}
        ...
        for (Iterator<Position> iter = sorted.iterator(); iter.hasNext();) {
            ...
            // get corresponding logo
            /************************************************* ADDED ROHITH ****************************/
            String teamName = positionName_vs_teamName.get(position.getName().trim());
            String logo = teamName_vs_logoName.get(teamName);
            //System.out.println ("Logo Number " + index + " is " + logo);
            /************************************************* ADDED ROHITH ****************************/
...
//    "        <td align='center'><span id='$row$Latest'>$price$&cent;</span><span style='float:right;opacity:0' id='$row$Reference'>$price$&cent;</span>\n" +
	"        <td align='center'><span id='$row$Latest'>$price$ paise</span><span style='float:right;opacity:0' id='$row$Reference'>$price$ paise</span>\n" +    		
...
"          <input type=text size=2 maxLength=2 name='$row$Target' onblur='$row$.handleBlur()' $defaultPrice$ onfocus='$row$.handleFocus()' onchange='$row$.handleChange()' autocomplete='off' >paise\n" //+    
//    "        <td align='center'>\\$\n" +
//	"        <td align='center'>&#x20b9\n" +
//"        <td align='center'>Rs.\n" +
...
;
            ...
            row.setAttribute("teamLogo",logo);
            /************************************************* ADDED ROHITH ****************************/            
    ...
    public static String historyChartNameForJsp(String claimName, boolean scalePrice, int chartHeight, int chartWidth) {
        ...
        try {
        	System.out.println("chartDirName : " + chartDirName + " lastTrade : " + lastTrade + " scalePrice : " + scalePrice );
    ...
    public String renderMakerPriceTable(Market market) {
        ...
        List listOfPositions = new ArrayList(); 
        for (int i = 0; i < positions.length; i++) {
        	listOfPositions.add(i);
        }
        System.out.println("Before Shuffle: " + listOfPositions.toString());
        Collections.shuffle(listOfPositions);
        System.out.println("After Shuffle: " + listOfPositions.toString());
        ...
        for (int i = 0; i < positions.length; i++) {
            ...
            System.out.println("Current Probability : " + value);
    ...
    private void saveLine(Probability prob, SortedMap<Probability, Set<String>> orderedLines, StringBuffer lineBuf) {
        ...
        if (s == null) {
            ...
            System.out.println("Putting in ordered Lines: Key --> " + p + " Value ---> " + s);
        }
        s.add(lineBuf.toString());
        System.out.println("Adding to ordered Lines HashSet String : " + lineBuf.toString());
    }
