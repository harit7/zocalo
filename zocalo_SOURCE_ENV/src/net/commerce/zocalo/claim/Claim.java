...
public abstract class Claim {
    ...
    public SortedSet<Position> sortPositions2() {    	
        Position[] positions = positions();
        SortedSet<Position> sorted = new TreeSet<Position>(
                new Comparator<Position>() {
                	
                    public int compare(Position p1, Position p2) {
                    	int result = p1.comparePersistentId(p2);
                    	int randomNumber = randomGenerator.nextInt(100);
                    	//System.out.println("Actual Result Got : " + result);
                    	//System.out.println("Random Number Generated  : " + randomNumber);
                    			
                    	if (randomGenerator.nextInt(100) < 50) {
                    		//System.out.println("Result Returned : " + result * -1);
                    		return result * -1; // swap the answer 
                    	}
                    	else {
