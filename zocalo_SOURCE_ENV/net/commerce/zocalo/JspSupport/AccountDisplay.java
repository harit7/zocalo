...
public class AccountDisplay extends UserPage {
    ...
    public String descriptionHtml1() {
        StringBuffer buf = new StringBuffer();
        buf.append("<p align=center><font size=3 color=blue><b><i> Welcome, abc " + getUserName() + ", to the Marketplace!</i></b></font></p>");
        buf.append("fuck you zocalo");
        buf.append("fuck you zocalo");
        ...
        //buf.append(HtmlSimpleElement.labelledLine("<font size=5 color=red><b>Your available Cash is: ", "&#x20b9;" + user.cashOnHand().printAsDollars())+" </b></font>");        
        buf.append(HtmlSimpleElement.labelledLine("<font size=5 color=red><b>Your available Cash is: ", "Rs." + user.cashOnHand().printAsDollars())+" </b></font>");
