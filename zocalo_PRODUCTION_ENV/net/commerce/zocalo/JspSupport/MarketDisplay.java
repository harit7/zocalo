...
//// REPORTING ///////////////////////////////////////////////////////////////
    ...
    public String getCashBalanceDisplay() {
        ...
        //return HtmlSimpleElement.labelledLine("<font size=5 color=red><b>Your present available Cash balance is: ", "&#x20b9;" + user.cashOnHand().printAsDollars()+"</b></font>");
        return HtmlSimpleElement.labelledLine("<font size=5 color=red><b>Your present available Cash balance is: ", "Rs." + user.cashOnHand().printAsDollars()+"</b></font>");
    }
    ...
    private void printOpenMultiMarkets(StringBuffer buf) {
        ...
        if (iterator.hasNext()) {
            buf.append("<p align=center><font size=5 color=blue><b><i>The ICC WorldCup Prediction Prediction League</b></i></font>");
            printMarketTableStart(buf);
