...
public class ChartGenerator {
    ...
    public static File updateChartFile(String webDirName, String chartDirName, Date lastTrade, final String claimName,
        ...
        Callable<Boolean> worker = new Callable<Boolean>() {
            public Boolean call() throws Exception {
                ...
                System.out.println("updateChartFile(): trades list : " + trades);
                TimePeriodValuesCollection prices = ChartGenerator.getHistoricalPrices(claimName, trades);
                JFreeChart chart = EMPTY_CHART;
                System.out.println("updateChartFile(): prices.getItemCount(0): " + prices.getItemCount(0));
                if (prices.getItemCount(0) != 0) {
    ...
    static public TimePeriodValuesCollection getHistoricalPrices(String claimName, List trades) {
        ...
        for (Iterator iterator = trades.iterator(); iterator.hasNext();) {
            ...
            System.out.println("getHistoricalPrices(): Quantity : " + trade.getQuantity());
            System.out.println("getHistoricalPrices(): Position : " + trade.getPos());
            System.out.println("getHistoricalPrices(): trade.getPos().isInvertedPosition() : " + trade.getPos().isInvertedPosition());            
            System.out.println("getHistoricalPrices(): trade.timeAndPriceInverted() : " + trade.timeAndPriceInverted());            
            System.out.println("getHistoricalPrices(): trade.timeAndPrice() : " + trade.timeAndPrice());
    ...
    static public TimePeriodValuesCollection getHistoricalVolumes(String claimName, List trades) {
        ...
        for (Iterator iterator = trades.iterator(); iterator.hasNext();) {
            ...
            System.out.println("getHistoricalVolumes: trade.timeAndVolume() " + trade.timeAndVolume());
            if (volume != null) {
                values.add(volume);
            }
        }
